...
- WBS-B3: P 행렬 명시 구성(절대뷰/상대뷰)과 Q 정합, **뷰 3축**(news/pattern/relationship) 앙상블 매핑(축 가중 $a$=(0.412, 0.412, 0.176), 합=1). anomaly는 뷰가 아니라 §B4의 $\Omega$ 신뢰도 변조 요인으로 분리([03 §5.1·§5.4](../design/03-bl-model-design.md)).
