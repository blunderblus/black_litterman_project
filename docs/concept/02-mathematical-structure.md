...
| $Q$ | 4축 AI 신호 앙상블 $Q_{final}=a^{\top}\tilde s$, 가중 $a=(0.35, 0.35, 0.15, 0.15)$ | §5.1–5.2 |
| $\Omega$ | $\Omega_{kk}=(P\tau\Sigma P^{\top})_{kk}\cdot \dfrac{1}{\mathrm{DRI}_i^{2}}\cdot \dfrac{1-\mathrm{conf}_i}{c_{cal}}$ (단위정합 × 무차원 신뢰가중), 하한 $\Omega_{floor}$ | §5.4 |
